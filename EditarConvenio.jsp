...
<html>
    ...
    <body> 
        ...
        <%
            ...
            sqlStr = ("select id,descricao from Consultorio_Convenio where id= '" + id + "' ;");
            //out.println("--    "+ sqlStr);
        ...
        <form action="UpdateConvenio.jsp" method="post">
            <fieldset>
                ...
                <div id="Convenio">
                    ...
                    <button class="but" type="submit" value="Inserir">Atualizar</button>
